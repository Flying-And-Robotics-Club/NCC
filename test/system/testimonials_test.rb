...
class TestimonialsTest < ApplicationSystemTestCase
  ...
  test "creating a Testimonial" do
    ...
    fill_in "Email", with: @testimonial.email
    fill_in "Facebook", with: @testimonial.facebook
    fill_in "Instagram", with: @testimonial.instagram
    fill_in "Linkedin", with: @testimonial.linkedin
    fill_in "Name", with: @testimonial.name
    fill_in "Phone", with: @testimonial.phone
    fill_in "Statement", with: @testimonial.statement
