...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { email: @testimonial.email, facebook: @testimonial.facebook, instagram: @testimonial.instagram, linkedin: @testimonial.linkedin, name: @testimonial.name, phone: @testimonial.phone, statement: @testimonial.statement } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { email: @testimonial.email, facebook: @testimonial.facebook, instagram: @testimonial.instagram, linkedin: @testimonial.linkedin, name: @testimonial.name, phone: @testimonial.phone, statement: @testimonial.statement } }
